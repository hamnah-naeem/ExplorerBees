...
//   const location = useLocation();
//   const isSocialPage = location.pathname === "/social";
//   const isLoginPage = location.pathname === "/login"; // Add this check

//   return (
//     <div className="min-h-screen flex flex-col">
//       {/* Only show Header if not on login page (since Login component has its own Header) */}
//       {!isLoginPage && <Header />}
...
//       {/* Only show Footer if not on social page or login page (since Login component has its own Footer) */}
//       {!isSocialPage && !isLoginPage && <Footer />}
//     </div>
//   );
// }
